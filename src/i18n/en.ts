...
export const en = {
  ...
  common: {
    ...
    pnpmNote: 'pnpm 12 installs a new release only once it is a day old — on a release day this scaffolds the previous version. npm is always current.',
  ...
  docsStart: {
    ...
    installSteps: [
      ...
      { title: 'Install and start the dev server' },
