...
export const en = {
  ...
  docs: {
    ...
    cards: [
      { slug: 'guide', title: 'Developer guide', body: 'Everything to build a real application: HTTP, tasks, cron, PostgreSQL, queues, sockets, services, testing, operating.' },
      { slug: 'sdk', title: 'SDK reference', body: 'Every export of @sakaladev/usai, /test and /config: signature, semantics, lifetime and an example.' },
      { slug: 'runbooks', title: 'Runbooks', body: 'One page per incident class, plus metrics, sizing, systemd, deploy and rollback.' },
      { slug: 'supported', title: 'Supported platforms', body: 'What is supported, where, and at what size — and what is not supported before 1.0.' },
    ],
  },
