---
# GENERATED by scripts/sync-docs.mjs from gmedia/usai@v0.0.9:docs/runbooks/deploy-and-rollback.md — do not edit; fix upstream and re-sync.
...
rolling restart above is unaffected), and [`postgres-down.md`](/docs/runbooks/postgres-down/) describes what
