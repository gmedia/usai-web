---
# GENERATED by scripts/sync-docs.mjs from gmedia/usai@v0.0.12:docs/runbooks/sizing.md — do not edit; fix upstream and re-sync.
...
with `last-event-id` and needs no heartbeat ([GUIDE §9](/docs/guide/#9-streams-and-websockets)). Past the budget an
...
[`SUPPORTED.md`](/docs/supported/) recommend — if you run 0.0.9, that warning is a known false
...
numbers. It deliberately stays quiet at the envelope [`SUPPORTED.md`](/docs/supported/) tells you
...
([`docs/measurements/2026-09-23-floor-accounting.md`](/docs/measurements/2026-09-23-floor-accounting/)): at 48 MiB the hello
...
([`docs/measurements/2026-09-24-bounded-soak.md`](/docs/measurements/2026-09-24-bounded-soak/)). The number that gets you
