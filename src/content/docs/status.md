---
# GENERATED by scripts/sync-docs.mjs from gmedia/usai@v0.0.13:docs/STATUS.md — do not edit; fix upstream and re-sync.
title: "Status"
slug: "status"
...
1. ~~Propose the idle-decommit API upstream~~ — **merged into
   ...
   we wanted it was wrong ([`docs/measurements/2026-09-26-idle-decommit.md`](/docs/measurements/2026-09-26-idle-decommit/)).
