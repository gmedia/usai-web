---
# GENERATED by scripts/sync-docs.mjs from gmedia/usai@v0.0.11:docs/CONTRACT-FREEZE.md — do not edit; fix upstream and re-sync.
...
7. ~~**What readiness means** (Q19)~~ — **settled 2026-09-24**
   ([ADR-0022](/docs/adr/0022-readiness-does-not-follow-a-shared-dependency/)):
