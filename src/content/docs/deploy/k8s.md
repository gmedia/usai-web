---
# GENERATED by scripts/sync-docs.mjs from gmedia/usai@v0.0.12:docs/deploy/k8s/README.md — do not edit; fix upstream and re-sync.
...
- [`usai-app.yaml`](https://github.com/gmedia/usai/blob/v0.0.12/docs/deploy/k8s/usai-app.yaml) — the web Deployment and everything around
...
- [`usai-singletons.yaml`](https://github.com/gmedia/usai/blob/v0.0.12/docs/deploy/k8s/usai-singletons.yaml) — the one-instance
