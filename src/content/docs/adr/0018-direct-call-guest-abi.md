---
# GENERATED by scripts/sync-docs.mjs from gmedia/usai@v0.0.13:docs/adr/0018-direct-call-guest-abi.md — do not edit; fix upstream and re-sync.
...
- `qjs_usai_enter(name, name_len, arg, arg_len) -> (len << 32) | ptr`: calls
  `__usai[name](https://github.com/gmedia/usai/tree/v0.0.13/docs/adr/arg)` with one string and leaves the result text in memory
